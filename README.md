...
![tests](https://github.com/chunyang666888/securities-research-kit/actions/workflows/ci.yml/badge.svg)
...
- **杜邦分析** (`dupont`)：将 ROE 拆解为「净利率 × 总资产周转率 × 权益乘数」，定位盈利 / 运营 / 杠杆驱动。
...
print(dupont_from_financials(fs))                 # ROE = 净利率 × 周转率 × 权益乘数
